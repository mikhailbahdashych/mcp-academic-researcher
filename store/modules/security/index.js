...
const state = () => ({
  ...
  securityOptions: [
    ...
    { title: 'Freeze account', text: 'When this feature is enabled, your account\'s activity will be stopped. You may apply to unfreeze your account the next time you log in.', buttonTitle: 'Freeze account', showModalParam: '' },
    { title: 'Close account', text: 'All account data will be removed without opportunity of recovering!', buttonTitle: 'Freeze account', showModalParam: 'closingAccount' },
  ]
})
